...
resource "aws_autoscaling_group" "autoscaling_group" {
  ...
  name = "asg_nonprod_eu-central-1_vault_001"
...
resource "aws_security_group" "lc_security_group" {
  #name_prefix = var.cluster_name
  name = "sg_nonprod_eu-central-1_vault_001"
...
resource "aws_iam_instance_profile" "instance_profile" {
  #name_prefix = var.cluster_name
  name = "iam_instprof_nonprod_eu-central-1_vault_001"
...
resource "aws_iam_role" "instance_role" {
  #name_prefix        = var.cluster_name
  name = "iam_role_nonprofit_eu-central-1_vault_001"
  assume_role_policy = data.aws_iam_policy_document.instance_role.json
  #assume_role_policy = data.aws_iam_policy_document.vault_policy_document.json
  managed_policy_arns = [aws_iam_policy.iam_get_roles.arn]
...
/*data "aws_iam_policy_document" "iam_get_role"{
  statement {
    sid = "IamGetRoles"
...
resource "aws_iam_policy" "iam_get_roles" {
  name = "iam_pol_vault_get_roles_001"
